...
var input1 = document.querySelector('textarea#textoUm');
var input2 = document.querySelector('textarea#textoDois');
...
function encrypt() {
    ...
    if (input1.value.length == 0) {
        ...
        document.getElementById('textoDois').innerHTML = `${txt}`;
...
function decrypt() {
    if (input1.value.length == 0) {
        ...
        //limpa a textoDois quando o botão é clicado pra poder exibir o resultado
        document.getElementById('none').innerHTML = '';
        document.querySelector('img.icone').style.display = 'none';
        document.getElementById('textoUm').innerHTML = '';
...
function copy() {
    ...
    document.querySelector("#textoUm").value = "";
    // input1.focus();
    // input2.value = "";
}
